...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([item isKindOfClass:[BOXFolder class]]) {
        controller = [[BOXSampleFolderViewController alloc] initWithClient:self.client
                                                                  folderID:((BOXFolder *)item).modelID];
    } else {
        controller = [[BOXSampleFileDetailsController alloc] initWithClient:self.client
                                                                     itemID:item.modelID itemType:item.type];
    }
